...
public:
  ...
  uint16_t getManID();
  uint32_t getJEDECID();
  uint32_t writeByte(uint32_t address, uint8_t data, bool errorCheck = true);
  uint32_t writeByte(uint16_t page_number, uint8_t offset, uint8_t data, bool errorCheck = true);
  uint32_t writeByteArray(uint32_t address, uint8_t *data_buffer, uint16_t bufferSize, bool errorCheck = true);
  uint32_t writeByteArray(uint16_t page_number, uint8_t offset, uint8_t *data_buffer, uint16_t bufferSize, bool errorCheck = true);
  uint32_t writeChar(uint32_t address, int8_t data, bool errorCheck = true);
  uint32_t writeChar(uint16_t page_number, uint8_t offset, int8_t data, bool errorCheck = true);
  uint32_t writeCharArray(uint32_t address, char *data_buffer, uint16_t bufferSize, bool errorCheck = true); 
  uint32_t writeCharArray(uint16_t page_number, uint8_t offset, char *data_buffer, uint16_t bufferSize, bool errorCheck = true); 
  uint32_t writeShort(uint32_t address, int16_t data, bool errorCheck = true);
  uint32_t writeShort(uint16_t page_number, uint8_t offset, int16_t data, bool errorCheck = true);
  ...
  uint32_t writePage(uint16_t page_number, uint8_t *data_buffer, bool errorCheck = true);
  uint32_t writeStr(uint32_t address, String &inputStr, bool errorCheck = true);
  uint32_t writeStr(uint16_t page_number, uint8_t offset, String &inputStr, bool errorCheck = true);
  ...
  uint32_t getMaxPage();
  uint32_t begin();
  void     readBytes(uint32_t address, uint8_t *data_buffer, uint16_t bufferSize, bool fastRead = false);
  void     readBytes(uint16_t page_number, uint8_t offset, uint8_t *data_buffer, uint16_t bufferSize, bool fastRead = false);
  bool     readChars(uint16_t page_number, uint8_t offset, char *data_buffer, uint16_t buffer_size, bool fastRead = false);
  bool     readChars(uint32_t address, char *data_buffer, uint16_t buffer_size, bool fastRead = false);
  void     readPage(uint16_t page_number, uint8_t *data_buffer, bool fastRead = false);
  uint32_t readStr(uint16_t page_number, uint8_t offset, String &outStr, bool fastRead = false);
  uint32_t readStr(uint32_t address, String &outStr, bool fastRead = false);
  ...
  template <class T> uint8_t writeAnything(uint16_t page_number, uint8_t offset, const T& value, bool errorCheck = true);
  template <class T> uint8_t writeAnything(uint32_t address, const T& value, bool errorCheck = true);
...
private:
  ...
  template <class T> uint8_t _writeErrorCheck(uint32_t address, const T& value);
...
// Variant A
template <class T> uint8_t SPIFlash::writeAnything(uint32_t address, const T& value, bool errorCheck) {  
...
// Variant B
template <class T> uint8_t SPIFlash::writeAnything(uint16_t page_number, uint8_t offset, const T& value, bool errorCheck) {
...
template <class T> uint8_t SPIFlash::_writeErrorCheck(uint32_t address, const T& value) {
if (!_prepRead(address))
    return false;
