void commandList() {
  ...
  Serial.println(F("                                                      SPIFlash library test v1.3.2                                                 "));
  Serial.println(F(" ----------------------------------------------------------------------------------------------------------------------------------"));
  Serial.println(F("                                                                Marzogh                                                            "));
  Serial.println(F("                                                              17.09.2015                                                           "));
  Serial.println(F(" ----------------------------------------------------------------------------------------------------------------------------------"));
  ...
  Serial.print(F("\t\t"));
  Serial.println(F("'6' followed by '33' writes bytes from 0 to 255 sequentially to fill page 33"));
  Serial.println(F("  7. readPage [page]"));
  Serial.print(F("\t\t"));
  Serial.println(F("'7' followed by 33 reads page 33"));
  Serial.println(F("  8. readAllPages"));
  Serial.print(F("\t\t"));
  Serial.println(F("'8' reads all 4096 pages and outputs them to the serial console"));
  Serial.print(F("\t\t"));
  ...
  Serial.println(F("  9. eraseSector"));
  Serial.print(F("\t\t"));
  Serial.println(F("'9' followed by '3' erases a 4KB sector (Sector 0) containing the page 3"));
  Serial.println(F("  10. eraseBlock32K"));
  Serial.print(F("\t\t"));
  Serial.println(F("'10' followed by '132' erases a 32KB sector (Sector 1) containing the page 132"));
  Serial.println(F("  11. eraseBlock64K"));
  Serial.print(F("\t\t"));
  Serial.println(F("'11' followed by '543' erases a 64KB sector (Sector 2) containing the page 543"));
  Serial.println(F("  12. eraseChip"));
  Serial.print(F("\t\t"));
  Serial.println(F("'12' erases the entire chip"));
  Serial.println(F(" ----------------------------------------------------------------------------------------------------------------------------------"));
}
