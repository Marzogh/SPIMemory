...
###### error()
Returns the error code generated by the function called immediately before this function is called. Refer to the [Error codes & Error reporting] (https://github.com/Marzogh/SPIFlash/wiki/Error-codes-&-Error-reporting) section the Wiki for further reference.
###### getMANID()
